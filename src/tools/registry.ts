...
const TAGS: TagDefinition[] = [
  { name: "feature", displayName: "Feature", category: "system", description: "New functionality" },
  { name: "bug", displayName: "Bug", category: "system", description: "Defect to fix" },
  { name: "chore", displayName: "Chore", category: "system", description: "Maintenance task" },
  { name: "spike", displayName: "Spike", category: "system", description: "Research/investigation" },
  { name: "code", displayName: "Code", category: "discipline", description: "Programming work" },
  { name: "design", displayName: "Design", category: "discipline", description: "Visual/UX design" },
  { name: "art", displayName: "Art", category: "discipline", description: "Art assets" },
  { name: "audio", displayName: "Audio", category: "discipline", description: "Sound/music" },
];
...
export function registerRegistryTools(server: McpServer): void {
  server.registerTool("get_tag_registry", {
  ...
  server.registerTool("get_lane_registry", {
